...
import { CampaignPlanSharesRateLimitGuard } from './campaignPlanSharesRateLimit.guard'
...
describe('CampaignPlanSharesRateLimitGuard', () => {
  let guard: CampaignPlanSharesRateLimitGuard

  beforeEach(() => {
    vi.useFakeTimers()
    vi.setSystemTime(new Date('2026-05-27T20:00:00Z'))
    guard = new CampaignPlanSharesRateLimitGuard()
  })
