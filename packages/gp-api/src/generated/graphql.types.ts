 ...
 *
 */
export type Action = DatabaseIdentifiable & Node & Slug & Timestamps & {
  __typename?: 'Action';
...
export type Address = DatabaseIdentifiable & Node & Timestamps & {
  __typename?: 'Address';
...
export type Argument = DatabaseIdentifiable & Node & {
  __typename?: 'Argument';
  /** Identifies the primary key from the database. */
  databaseId: Scalars['Int']['output'];
  id: Scalars['ID']['output'];
...
export type Ballot = DatabaseIdentifiable & Node & Timestamps & {
  __typename?: 'Ballot';
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Identifies the primary key from the database. */
...
export type BallotEvent = DatabaseIdentifiable & Node & Timestamps & {
...
export type Body = DatabaseIdentifiable & GeographicalIdentifiers & Node & Timestamps & {
  __typename?: 'Body';
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Identifies the primary key from the database. */
...
export type BodyMember = DatabaseIdentifiable & Node & {
 ...
 *
 */
export type Candidacy = DatabaseIdentifiable & Node & Timestamps & {
...
export type CandidateUrl = DatabaseIdentifiable & Node & {
...
export type ConstituentContact = DatabaseIdentifiable & Node & Timestamps & {
...
export type Degree = DatabaseIdentifiable & Node & {
  __typename?: 'Degree';
  /** Identifies the primary key from the database. */
  databaseId: Scalars['Int']['output'];
...
export type Election = DatabaseIdentifiable & HasRaces & Node & Slug & Timestamps & {
  __typename?: 'Election';
  ...
  candidateInformationPublishedAt?: Maybe<Scalars['ISO8601DateTime']['output']>;
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Identifies the primary key from the database. */
  databaseId: Scalars['Int']['output'];
...
export type Endorsement = DatabaseIdentifiable & Node & Timestamps & {
...
export type Experience = DatabaseIdentifiable & Node & {
...
export type FilingPeriod = DatabaseIdentifiable & Node & Timestamps & {
...
export type Form = DatabaseIdentifiable & Node & {
  __typename?: 'Form';
  /** Identifies the primary key from the database. */
  databaseId: Scalars['Int']['output'];
...
export type Geofence = DatabaseIdentifiable & GeographicalIdentifiers & Node & Timestamps & {
  __typename?: 'Geofence';
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Identifies the primary key from the database. */
 ...
 *
 */
export type Issue = DatabaseIdentifiable & Node & {
  __typename?: 'Issue';
  /** Identifies the primary key from the database. */
  databaseId: Scalars['Int']['output'];
...
/** Ballot measures */
export type Measure = DatabaseIdentifiable & GeographicalIdentifiers & Node & Slug & Timestamps & {
  __typename?: 'Measure';
 ...
 *
 */
export type Mtfcc = DatabaseIdentifiable & Node & Timestamps & {
  __typename?: 'Mtfcc';
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Identifies the primary key from the database. */
...
export type NormalizedPosition = DatabaseIdentifiable & Node & {
 ...
 *
 */
export type OfficeHolder = DatabaseIdentifiable & Node & Timestamps & {
...
export type OfficeHolderUrl = DatabaseIdentifiable & Node & {
...
export type Organization = DatabaseIdentifiable & Node & Timestamps & {
...
export type Party = DatabaseIdentifiable & Node & Timestamps & {
  __typename?: 'Party';
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
  /** Identifies the primary key from the database. */
 ...
 *
 */
export type Person = DatabaseIdentifiable & HasCandidacies & HasOfficeHolders & Node & Slug & Timestamps & {
  __typename?: 'Person';
...
export type Place = DatabaseIdentifiable & GeographicalIdentifiers & Node & Slug & Timestamps & {
  __typename?: 'Place';
  addresses: Array<Address>;
  /**
 ...
 *
 */
export type Position = DatabaseIdentifiable & GeographicalIdentifiers & HasOfficeHolders & Node & Slug & Timestamps & {
  __typename?: 'Position';
...
export type PositionElectionFrequency = DatabaseIdentifiable & Node & {
 ...
 *
 */
export type Race = DatabaseIdentifiable & HasCandidacies & Node & Timestamps & {
  __typename?: 'Race';
  candidacies: Array<Candidacy>;
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['ISO8601DateTime']['output'];
...
export type RegistrationOption = DatabaseIdentifiable & Node & Timestamps & {
   ...
   *
   */
  availableIfDateOfBirthBeforeOrEquals?: Maybe<Scalars['ISO8601Date']['output']>;
...
export type Stance = DatabaseIdentifiable & Node & {
  __typename?: 'Stance';
  /** Identifies the primary key from the database. */
  databaseId: Scalars['Int']['output'];
  id: Scalars['ID']['output'];
...
export type SuggestedCandidacy = DatabaseIdentifiable & Node & Timestamps & {
...
export type VotingDay = DatabaseIdentifiable & Node & Timestamps & {
 ...
 *
 */
export type VotingLocation = DatabaseIdentifiable & GeographicalIdentifiers & Node & Timestamps & {
...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  DatabaseIdentifiable: ( Action ) | ( Address ) | ( Argument ) | ( Ballot ) | ( BallotEvent ) | ( Body ) | ( BodyMember ) | ( Candidacy ) | ( CandidateUrl ) | ( ConstituentContact ) | ( Degree ) | ( Election ) | ( Endorsement ) | ( Experience ) | ( FilingPeriod ) | ( Form ) | ( Geofence ) | ( Issue ) | ( Measure ) | ( Mtfcc ) | ( NormalizedPosition ) | ( OfficeHolder ) | ( OfficeHolderUrl ) | ( Organization ) | ( Party ) | ( Person ) | ( Place ) | ( Position ) | ( PositionElectionFrequency ) | ( Race ) | ( RegistrationOption ) | ( Stance ) | ( SuggestedCandidacy ) | ( Url ) | ( VotingDay ) | ( VotingLocation );
  GeographicalIdentifiers: ( Body ) | ( Geofence ) | ( Measure ) | ( Place ) | ( Position ) | ( VotingLocation );
  HasCandidacies: ( Person ) | ( Race );
  HasOfficeHolders: ( Person ) | ( Position );
  HasRaces: ( Election );
  Node: ( Action ) | ( Address ) | ( Argument ) | ( Ballot ) | ( BallotEvent ) | ( Body ) | ( BodyMember ) | ( Candidacy ) | ( CandidateUrl ) | ( ConstituentContact ) | ( Degree ) | ( Election ) | ( Endorsement ) | ( Experience ) | ( FilingPeriod ) | ( Form ) | ( Geofence ) | ( Issue ) | ( Measure ) | ( Mtfcc ) | ( NormalizedPosition ) | ( OfficeHolder ) | ( OfficeHolderUrl ) | ( Organization ) | ( Party ) | ( Person ) | ( Place ) | ( Position ) | ( PositionElectionFrequency ) | ( Race ) | ( RegistrationOption ) | ( Stance ) | ( SuggestedCandidacy ) | ( VotingDay ) | ( VotingLocation );
  Slug: ( Action ) | ( Election ) | ( Measure ) | ( Person ) | ( Place ) | ( Position );
  Timestamps: ( Action ) | ( Address ) | ( Ballot ) | ( BallotEvent ) | ( Body ) | ( Candidacy ) | ( ConstituentContact ) | ( Election ) | ( Endorsement ) | ( FilingPeriod ) | ( Geofence ) | ( Measure ) | ( Mtfcc ) | ( OfficeHolder ) | ( Organization ) | ( Party ) | ( Person ) | ( Place ) | ( Position ) | ( Race ) | ( RegistrationOption ) | ( SuggestedCandidacy ) | ( VotingDay ) | ( VotingLocation );
};
...
export type ResolversTypes = {
  ...
  DatabaseIdentifiable: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['DatabaseIdentifiable']>;
  ...
  GeographicalIdentifiers: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['GeographicalIdentifiers']>;
  HasCandidacies: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['HasCandidacies']>;
  HasOfficeHolders: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['HasOfficeHolders']>;
  HasRaces: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['HasRaces']>;
  ...
  Timestamps: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['Timestamps']>;
...
export type exampleDirectiveResolver<Result, Parent, ContextType = any, Args = exampleDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type ActionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Action'] = ResolversParentTypes['Action']> = {
  ...
  destinationUrl?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ActionConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActionConnection'] = ResolversParentTypes['ActionConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['ActionEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['Action']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ActionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ActionEdge'] = ResolversParentTypes['ActionEdge']> = {
...
export type BallotResolvers<ContextType = any, ParentType extends ResolversParentTypes['Ballot'] = ResolversParentTypes['Ballot']> = {
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
...
export type BallotEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['BallotEvent'] = ResolversParentTypes['BallotEvent']> = {
...
export type BodyMemberResolvers<ContextType = any, ParentType extends ResolversParentTypes['BodyMember'] = ResolversParentTypes['BodyMember']> = {
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type CandidacyResolvers<ContextType = any, ParentType extends ResolversParentTypes['Candidacy'] = ResolversParentTypes['Candidacy']> = {
  ...
  result?: Resolver<Maybe<ResolversTypes['ElectionResult']>, ParentType, ContextType>;
...
export type CandidateUrlResolvers<ContextType = any, ParentType extends ResolversParentTypes['CandidateUrl'] = ResolversParentTypes['CandidateUrl']> = {
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type ConstituentContactResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConstituentContact'] = ResolversParentTypes['ConstituentContact']> = {
...
export type CreateBallotEventPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateBallotEventPayload'] = ResolversParentTypes['CreateBallotEventPayload']> = {
  ballotEvent?: Resolver<Maybe<ResolversTypes['BallotEvent']>, ParentType, ContextType>;
  clientMutationId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  errors?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CreateBallotPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateBallotPayload'] = ResolversParentTypes['CreateBallotPayload']> = {
  ballot?: Resolver<Maybe<ResolversTypes['Ballot']>, ParentType, ContextType>;
  clientMutationId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  engineToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  errors?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CreateConstituentContactPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreateConstituentContactPayload'] = ResolversParentTypes['CreateConstituentContactPayload']> = {
  clientMutationId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  contact?: Resolver<Maybe<ResolversTypes['ConstituentContact']>, ParentType, ContextType>;
  errors?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DatabaseIdentifiableResolvers<ContextType = any, ParentType extends ResolversParentTypes['DatabaseIdentifiable'] = ResolversParentTypes['DatabaseIdentifiable']> = {
  __resolveType: TypeResolveFn<'Action' | 'Address' | 'Argument' | 'Ballot' | 'BallotEvent' | 'Body' | 'BodyMember' | 'Candidacy' | 'CandidateUrl' | 'ConstituentContact' | 'Degree' | 'Election' | 'Endorsement' | 'Experience' | 'FilingPeriod' | 'Form' | 'Geofence' | 'Issue' | 'Measure' | 'Mtfcc' | 'NormalizedPosition' | 'OfficeHolder' | 'OfficeHolderUrl' | 'Organization' | 'Party' | 'Person' | 'Place' | 'Position' | 'PositionElectionFrequency' | 'Race' | 'RegistrationOption' | 'Stance' | 'SuggestedCandidacy' | 'Url' | 'VotingDay' | 'VotingLocation', ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
};
...
export type ElectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Election'] = ResolversParentTypes['Election']> = {
  ballotsSentOutBy?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  candidateInformationPublishedAt?: Resolver<Maybe<ResolversTypes['ISO8601DateTime']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  measures?: Resolver<ResolversTypes['MeasureConnection'], ParentType, ContextType, Partial<ElectionmeasuresArgs>>;
  milestones?: Resolver<Array<ResolversTypes['Milestone']>, ParentType, ContextType, Partial<ElectionmilestonesArgs>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  originalElectionDate?: Resolver<ResolversTypes['ISO8601Date'], ParentType, ContextType>;
  raceCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  races?: Resolver<ResolversTypes['RaceConnection'], ParentType, ContextType, Partial<ElectionracesArgs>>;
  slug?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  state?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  timezone?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  vipElections?: Resolver<Array<ResolversTypes['VipElection']>, ParentType, ContextType>;
  votingDays?: Resolver<ResolversTypes['VotingDayConnection'], ParentType, ContextType, Partial<ElectionvotingDaysArgs>>;
  votingInformationPublishedAt?: Resolver<Maybe<ResolversTypes['ISO8601DateTime']>, ParentType, ContextType>;
  votingLocations?: Resolver<ResolversTypes['VotingLocationConnection'], ParentType, ContextType, Partial<ElectionvotingLocationsArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ElectionConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ElectionConnection'] = ResolversParentTypes['ElectionConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['ElectionEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['Election']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type EndorsementResolvers<ContextType = any, ParentType extends ResolversParentTypes['Endorsement'] = ResolversParentTypes['Endorsement']> = {
  ...
  recommendation?: Resolver<Maybe<ResolversTypes['Sentiment']>, ParentType, ContextType>;
  status?: Resolver<ResolversTypes['EndorsementStatusTypeField'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type FilingPeriodResolvers<ContextType = any, ParentType extends ResolversParentTypes['FilingPeriod'] = ResolversParentTypes['FilingPeriod']> = {
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  endOn?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  notes?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  startOn?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  type?: Resolver<Maybe<ResolversTypes['FilingPeriodType']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type GeofenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['Geofence'] = ResolversParentTypes['Geofence']> = {
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  geoId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  mtfcc?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  validFrom?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  validTo?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type GeographicalIdentifiersResolvers<ContextType = any, ParentType extends ResolversParentTypes['GeographicalIdentifiers'] = ResolversParentTypes['GeographicalIdentifiers']> = {
  __resolveType: TypeResolveFn<'Body' | 'Geofence' | 'Measure' | 'Place' | 'Position' | 'VotingLocation', ParentType, ContextType>;
  geoId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  mtfcc?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};

export type HasCandidaciesResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasCandidacies'] = ResolversParentTypes['HasCandidacies']> = {
  __resolveType: TypeResolveFn<'Person' | 'Race', ParentType, ContextType>;
  candidacies?: Resolver<Array<ResolversTypes['Candidacy']>, ParentType, ContextType, Partial<HasCandidaciescandidaciesArgs>>;
};

export type HasOfficeHoldersResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasOfficeHolders'] = ResolversParentTypes['HasOfficeHolders']> = {
  __resolveType: TypeResolveFn<'Person' | 'Position', ParentType, ContextType>;
  officeHolders?: Resolver<ResolversTypes['OfficeHolderConnection'], ParentType, ContextType, Partial<HasOfficeHoldersofficeHoldersArgs>>;
};

export type HasRacesResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasRaces'] = ResolversParentTypes['HasRaces']> = {
  __resolveType: TypeResolveFn<'Election', ParentType, ContextType>;
  raceCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  races?: Resolver<ResolversTypes['RaceConnection'], ParentType, ContextType, Partial<HasRacesracesArgs>>;
};

export type HeadshotResolvers<ContextType = any, ParentType extends ResolversParentTypes['Headshot'] = ResolversParentTypes['Headshot']> = {
...
export type IssueResolvers<ContextType = any, ParentType extends ResolversParentTypes['Issue'] = ResolversParentTypes['Issue']> = {
  ...
  pluginEnabled?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  responseType?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type MeasureResolvers<ContextType = any, ParentType extends ResolversParentTypes['Measure'] = ResolversParentTypes['Measure']> = {
  arguments?: Resolver<Maybe<Array<ResolversTypes['Argument']>>, ParentType, ContextType>;
  conSnippet?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  election?: Resolver<ResolversTypes['Election'], ParentType, ContextType>;
  endorsements?: Resolver<Array<ResolversTypes['Endorsement']>, ParentType, ContextType>;
  geoId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasUnknownBoundaries?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  proSnippet?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  slug?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  state?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MeasureConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MeasureConnection'] = ResolversParentTypes['MeasureConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['MeasureEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['Measure']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MeasureEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['MeasureEdge'] = ResolversParentTypes['MeasureEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MilestoneResolvers<ContextType = any, ParentType extends ResolversParentTypes['Milestone'] = ResolversParentTypes['Milestone']> = {
  category?: Resolver<ResolversTypes['MilestoneCategory'], ParentType, ContextType>;
  channel?: Resolver<ResolversTypes['MilestoneChannel'], ParentType, ContextType>;
  date?: Resolver<ResolversTypes['ISO8601Date'], ParentType, ContextType>;
  datetime?: Resolver<Maybe<ResolversTypes['ISO8601DateTime']>, ParentType, ContextType>;
  features?: Resolver<Array<ResolversTypes['MilestoneFeature']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['MilestoneObject'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MtfccResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mtfcc'] = ResolversParentTypes['Mtfcc']> = {
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type MtfccConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MtfccConnection'] = ResolversParentTypes['MtfccConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['MtfccEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['Mtfcc']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MtfccEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['MtfccEdge'] = ResolversParentTypes['MtfccEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createBallot?: Resolver<Maybe<ResolversTypes['CreateBallotPayload']>, ParentType, ContextType, RequireFields<MutationcreateBallotArgs, 'input'>>;
  createBallotEvent?: Resolver<Maybe<ResolversTypes['CreateBallotEventPayload']>, ParentType, ContextType, RequireFields<MutationcreateBallotEventArgs, 'input'>>;
  createContact?: Resolver<Maybe<ResolversTypes['CreateConstituentContactPayload']>, ParentType, ContextType, RequireFields<MutationcreateContactArgs, 'input'>>;
};
...
export type NormalizedPositionResolvers<ContextType = any, ParentType extends ResolversParentTypes['NormalizedPosition'] = ResolversParentTypes['NormalizedPosition']> = {
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type OfficeHolderResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfficeHolder'] = ResolversParentTypes['OfficeHolder']> = {
  addresses?: Resolver<Array<ResolversTypes['Address']>, ParentType, ContextType>;
  centralPhone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  contacts?: Resolver<Array<ResolversTypes['Contact']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  endAt?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  officeTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  otherPhone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  parties?: Resolver<Array<ResolversTypes['Party']>, ParentType, ContextType>;
  ...
  specificity?: Resolver<Maybe<ResolversTypes['DateSpecificity']>, ParentType, ContextType>;
  startAt?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  totalYearsInOffice?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  urls?: Resolver<Array<ResolversTypes['Url']>, ParentType, ContextType, RequireFields<OfficeHolderurlsArgs, 'limit'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfficeHolderConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfficeHolderConnection'] = ResolversParentTypes['OfficeHolderConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['OfficeHolderEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['OfficeHolder']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfficeHolderEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfficeHolderEdge'] = ResolversParentTypes['OfficeHolderEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<Maybe<ResolversTypes['OfficeHolder']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OfficeHolderUrlResolvers<ContextType = any, ParentType extends ResolversParentTypes['OfficeHolderUrl'] = ResolversParentTypes['OfficeHolderUrl']> = {
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  entryType?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type OrganizationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Organization'] = ResolversParentTypes['Organization']> = {
  children?: Resolver<Array<ResolversTypes['Organization']>, ParentType, ContextType>;
  ...
  retiredAt?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  state?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
...
export type PersonResolvers<ContextType = any, ParentType extends ResolversParentTypes['Person'] = ResolversParentTypes['Person']> = {
  ...
  candidacies?: Resolver<Array<ResolversTypes['Candidacy']>, ParentType, ContextType, Partial<PersoncandidaciesArgs>>;
  contacts?: Resolver<Array<ResolversTypes['Contact']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  ...
  officeHolders?: Resolver<ResolversTypes['OfficeHolderConnection'], ParentType, ContextType, Partial<PersonofficeHoldersArgs>>;
  phone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  slug?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  suffix?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  urls?: Resolver<Array<ResolversTypes['Url']>, ParentType, ContextType, RequireFields<PersonurlsArgs, 'limit'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type PlaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['Place'] = ResolversParentTypes['Place']> = {
  addresses?: Resolver<Array<ResolversTypes['Address']>, ParentType, ContextType, Partial<PlaceaddressesArgs>>;
  canVoteInPrimaryWhen18ByGeneral?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  contacts?: Resolver<Array<ResolversTypes['Contact']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  dissolved?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  forms?: Resolver<Array<ResolversTypes['Form']>, ParentType, ContextType, Partial<PlaceformsArgs>>;
  geoId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasVoteByMail?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isPrintingEnabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  isReceiverOfVoteByMailRequests?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  mtfcc?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  positions?: Resolver<ResolversTypes['PositionConnection'], ParentType, ContextType, Partial<PlacepositionsArgs>>;
  primaryType?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  registrationOptions?: Resolver<Array<ResolversTypes['RegistrationOption']>, ParentType, ContextType>;
  slug?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  state?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PlaceConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlaceConnection'] = ResolversParentTypes['PlaceConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['PlaceEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['Place']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type PositionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Position'] = ResolversParentTypes['Position']> = {
  ...
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  electionFrequencies?: Resolver<Array<ResolversTypes['PositionElectionFrequency']>, ParentType, ContextType>;
  eligibilityRequirements?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  employmentType?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  filingAddress?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  filingPhone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  filingRequirements?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  geoId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasMajorityVotePrimary?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasPrimary?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  hasRankedChoiceGeneral?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasRankedChoicePrimary?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasUnknownBoundaries?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  issues?: Resolver<Array<ResolversTypes['Issue']>, ParentType, ContextType>;
  ...
  maximumFilingFee?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  minimumAge?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  mtfcc?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  mustBeRegisteredVoter?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  mustBeResident?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  mustHaveProfessionalExperience?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  normalizedPosition?: Resolver<ResolversTypes['NormalizedPosition'], ParentType, ContextType>;
  officeHolders?: Resolver<ResolversTypes['OfficeHolderConnection'], ParentType, ContextType, Partial<PositionofficeHoldersArgs>>;
  paperworkInstructions?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  partisanType?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  places?: Resolver<ResolversTypes['PlaceConnection'], ParentType, ContextType, Partial<PositionplacesArgs>>;
  races?: Resolver<ResolversTypes['RaceConnection'], ParentType, ContextType, Partial<PositionracesArgs>>;
  rankedChoiceMaxVotesGeneral?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  rankedChoiceMaxVotesPrimary?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  ...
  runningMateStyle?: Resolver<Maybe<ResolversTypes['RunningMate']>, ParentType, ContextType>;
  ...
  state?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  subAreaName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  subAreaValue?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PositionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PositionEdge'] = ResolversParentTypes['PositionEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  isContained?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  node?: Resolver<Maybe<ResolversTypes['Position']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PositionElectionFrequencyResolvers<ContextType = any, ParentType extends ResolversParentTypes['PositionElectionFrequency'] = ResolversParentTypes['PositionElectionFrequency']> = {
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  actions?: Resolver<ResolversTypes['ActionConnection'], ParentType, ContextType, Partial<QueryactionsArgs>>;
  complexity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  elections?: Resolver<ResolversTypes['ElectionConnection'], ParentType, ContextType, Partial<QueryelectionsArgs>>;
  issues?: Resolver<ResolversTypes['IssueConnection'], ParentType, ContextType, Partial<QueryissuesArgs>>;
  measures?: Resolver<ResolversTypes['MeasureConnection'], ParentType, ContextType, Partial<QuerymeasuresArgs>>;
  mtfcc?: Resolver<ResolversTypes['MtfccConnection'], ParentType, ContextType, Partial<QuerymtfccArgs>>;
  node?: Resolver<Maybe<ResolversTypes['Node']>, ParentType, ContextType, RequireFields<QuerynodeArgs, 'id'>>;
  nodeBySlug?: Resolver<Maybe<ResolversTypes['Node']>, ParentType, ContextType, RequireFields<QuerynodeBySlugArgs, 'objectType' | 'slug'>>;
  nodes?: Resolver<Array<Maybe<ResolversTypes['Node']>>, ParentType, ContextType, RequireFields<QuerynodesArgs, 'ids'>>;
  officeHolders?: Resolver<ResolversTypes['OfficeHolderConnection'], ParentType, ContextType, Partial<QueryofficeHoldersArgs>>;
  organizations?: Resolver<ResolversTypes['OrganizationConnection'], ParentType, ContextType, Partial<QueryorganizationsArgs>>;
  people?: Resolver<ResolversTypes['PersonConnection'], ParentType, ContextType, Partial<QuerypeopleArgs>>;
  places?: Resolver<ResolversTypes['PlaceConnection'], ParentType, ContextType, Partial<QueryplacesArgs>>;
  positions?: Resolver<ResolversTypes['PositionConnection'], ParentType, ContextType, Partial<QuerypositionsArgs>>;
  races?: Resolver<ResolversTypes['RaceConnection'], ParentType, ContextType, Partial<QueryracesArgs>>;
  votingLocations?: Resolver<ResolversTypes['VotingLocationConnection'], ParentType, ContextType, RequireFields<QueryvotingLocationsArgs, 'filterBy'>>;
};

export type RaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['Race'] = ResolversParentTypes['Race']> = {
  candidacies?: Resolver<Array<ResolversTypes['Candidacy']>, ParentType, ContextType, Partial<RacecandidaciesArgs>>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  election?: Resolver<ResolversTypes['Election'], ParentType, ContextType>;
  filingPeriods?: Resolver<Array<ResolversTypes['FilingPeriod']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isDisabled?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  isPartisan?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
...
export type RaceConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['RaceConnection'] = ResolversParentTypes['RaceConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['RaceEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['Race']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RaceEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['RaceEdge'] = ResolversParentTypes['RaceEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<Maybe<ResolversTypes['Race']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RegistrationOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['RegistrationOption'] = ResolversParentTypes['RegistrationOption']> = {
  availableIfDateOfBirthBeforeOrEquals?: Resolver<Maybe<ResolversTypes['ISO8601Date']>, ParentType, ContextType>;
  channel?: Resolver<ResolversTypes['RegistrationOptionChannel'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  documents?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  eligibility?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  features?: Resolver<Array<ResolversTypes['RegistrationOptionFeature']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isIdRequired?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  isPreregistration?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  place?: Resolver<ResolversTypes['Place'], ParentType, ContextType>;
  safestRegistrationDeadlineInDays?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SlugResolvers<ContextType = any, ParentType extends ResolversParentTypes['Slug'] = ResolversParentTypes['Slug']> = {
  __resolveType: TypeResolveFn<'Action' | 'Election' | 'Measure' | 'Person' | 'Place' | 'Position', ParentType, ContextType>;
  slug?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type StanceResolvers<ContextType = any, ParentType extends ResolversParentTypes['Stance'] = ResolversParentTypes['Stance']> = {
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type SuggestedCandidacyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SuggestedCandidacy'] = ResolversParentTypes['SuggestedCandidacy']> = {
...
export type TimestampsResolvers<ContextType = any, ParentType extends ResolversParentTypes['Timestamps'] = ResolversParentTypes['Timestamps']> = {
  __resolveType: TypeResolveFn<'Action' | 'Address' | 'Ballot' | 'BallotEvent' | 'Body' | 'Candidacy' | 'ConstituentContact' | 'Election' | 'Endorsement' | 'FilingPeriod' | 'Geofence' | 'Measure' | 'Mtfcc' | 'OfficeHolder' | 'Organization' | 'Party' | 'Person' | 'Place' | 'Position' | 'Race' | 'RegistrationOption' | 'SuggestedCandidacy' | 'VotingDay' | 'VotingLocation', ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
};
...
export type VipElectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['VipElection'] = ResolversParentTypes['VipElection']> = {
  party?: Resolver<Maybe<ResolversTypes['Party']>, ParentType, ContextType>;
  vipId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type VotingDayResolvers<ContextType = any, ParentType extends ResolversParentTypes['VotingDay'] = ResolversParentTypes['VotingDay']> = {
...
export type VotingDayConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['VotingDayConnection'] = ResolversParentTypes['VotingDayConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['VotingDayEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['VotingDay']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type VotingDayEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['VotingDayEdge'] = ResolversParentTypes['VotingDayEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<Maybe<ResolversTypes['VotingDay']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type VotingLocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['VotingLocation'] = ResolversParentTypes['VotingLocation']> = {
  address?: Resolver<Maybe<ResolversTypes['Address']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  databaseId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  election?: Resolver<ResolversTypes['Election'], ParentType, ContextType>;
  ...
  timezone?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  votingDays?: Resolver<ResolversTypes['VotingDayConnection'], ParentType, ContextType, Partial<VotingLocationvotingDaysArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type VotingLocationConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['VotingLocationConnection'] = ResolversParentTypes['VotingLocationConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['VotingLocationEdge']>>>, ParentType, ContextType>;
  nodes?: Resolver<Maybe<Array<Maybe<ResolversTypes['VotingLocation']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type VotingLocationEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['VotingLocationEdge'] = ResolversParentTypes['VotingLocationEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<Maybe<ResolversTypes['VotingLocation']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
