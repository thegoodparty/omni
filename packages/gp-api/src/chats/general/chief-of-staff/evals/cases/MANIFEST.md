...
Distribution: severity blocker 43 / high 68 / medium 38 / low 2; oracle exact 14 / trace 16 / constraint 68 / rubric 53 (D3-04 regraded rubric to exact, AX-10 raised high to blocker, 2026-08-03).
...
- `prompts:` (list) + `turn_expectations:` (list, index-aligned) — multi-turn
  cases (H, some F, PR-01 in G, and B06 in A). Sent sequentially in one conversation. Needs turn.py.
