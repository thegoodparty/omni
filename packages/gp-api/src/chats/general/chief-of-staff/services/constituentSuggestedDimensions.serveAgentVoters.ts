...
// verbatim):
// - hs_* labels state the stance the score measures, sourced from the
//   column-documentation seed in gp-data-platform
//   (dbt/project/seeds/l2_column_classification.csv — many rows carry the
//   original survey question) and the briefing-chat topic catalog, not a
//   Title-Case of the column name. Scores are within-state percentile ranks
//   centered at 50; scale/threshold framing lives in HS_SCORE_SEMANTICS
//   (llm/tools/hsScoreSemantics.ts), so keep labels to the stance.
...
export const SERVE_AGENT_VOTER_SUGGESTED_DIMENSIONS: AdvertisedDimension[] = [
  ...
  },
  {
    ...
    label: 'Opposes age limits (subject unspecified in documentation)',
  },
  {
    name: 'hs_age_limit_support',
    label: 'Supports age limits (subject unspecified in documentation)',
  },
  {
    name: 'hs_aliens_governenment_disclosed_all',
    label:
      'Believes the government has disclosed all it knows about aliens/UFOs (limited coverage: data exists in only 12 states; null elsewhere)',
  },
  {
  ...
  { name: 'hs_casino_oppose', label: 'Opposes allowing casino gambling' },
  { name: 'hs_casino_support', label: 'Supports allowing casino gambling' },
  {
    name: 'hs_charity_giving_enviro_cause',
    label: 'Gives to environmental charities',
  },
  {
    name: 'hs_charity_giving_international_aid',
    label: 'Gives to international aid charities',
  },
  {
    name: 'hs_charity_giving_performing_arts',
    label: 'Gives to performing arts charities',
  },
  {
    name: 'hs_charity_giving_vet_cause',
    label: "Gives to veterans' charities",
  },
  ...
  },
  {
    ...
    label:
      'Sees their community as not integrated (limited coverage: no data in 12 states; null there)',
  },
  {
    name: 'hs_community_very_integrated',
    label:
      'Sees their community as very integrated (limited coverage: no data in 12 states; null there)',
  },
  {
  ...
  { name: 'hs_crypto_buyer_no', label: 'Has not bought cryptocurrency' },
  { name: 'hs_crypto_buyer_yes', label: 'Has bought cryptocurrency' },
  {
  ...
  },
  {
    ...
    label: 'Votes only the top of the ballot, skipping down-ballot races',
  },
  {
  ...
  },
  {
    ...
    label:
      'Feels economically ahead of where they expected to be (limited coverage: no data in 12 states; null there)',
  },
  {
    name: 'hs_economic_despondency_far_behind',
    label:
      'Feels economically far behind where they expected to be (limited coverage: no data in 12 states; null there)',
  },
  {
    name: 'hs_electric_vehicle_likely_buyer',
    label: 'Likely to buy an electric vehicle',
  },
  {
  ...
  },
  {
    name: 'hs_gamer_yes',
    label:
      'Plays video games (limited coverage: no data in 12 states; null there)',
  },
  { name: 'hs_gas_tax_oppose', label: 'Opposes the gas tax' },
  { name: 'hs_gas_tax_support', label: 'Supports the gas tax' },
  {
    name: 'hs_general_anti_vax_pro_vax',
    label:
      'Vaccine attitude scale (which end is pro-vax is not documented; do not use without confirming direction)',
  },
  ...
  },
  {
    ...
    label: 'Blames inflation on external events like Covid-19',
  },
  {
  ...
  },
  {
    ...
    label: 'Supports pardons for January 6th defendants',
  },
  {
  ...
  {
    name: 'hs_likely_ev',
    label: 'Likely to vote early (in-person early voting)',
  },
  ...
  },
  {
    ...
    label: 'Supports marijuana legalization',
  },
  {
  ...
  { name: 'hs_responsiveness_email', label: 'Responsive to email outreach' },
  {
    ...
    label: 'Responsive to live phone or door-knock contact',
  },
  ...
  { name: 'hs_school_funding_less', label: 'Favors less school funding' },
  ...
  { name: 'hs_solar_panel_buyer_no', label: 'Has not bought solar panels' },
  { name: 'hs_solar_panel_buyer_yes', label: 'Has bought solar panels' },
  {
  ...
  },
  {
    ...
    label:
      'Opposes superpower policy (subject unspecified in documentation) (limited coverage: no data in 12 states; null there)',
  },
  {
    name: 'hs_super_power_policy_support',
    label:
      'Supports superpower policy (subject unspecified in documentation) (limited coverage: no data in 12 states; null there)',
  },
  ...
  { name: 'hs_tv_viewer_watch_any_tv', label: 'Watches any TV regularly' },
  {
  ...
  { name: 'hs_unions_not_beneficial', label: 'Views unions as not beneficial' },
  {
    ...
    label:
      'Believes UnitedHealthcare is at fault (context unspecified) (limited coverage: data exists in only 12 states; null elsewhere)',
  },
  {
    name: 'hs_united_healthcare_no_fault',
    label:
      'Believes UnitedHealthcare is not at fault (context unspecified) (limited coverage: data exists in only 12 states; null elsewhere)',
  },
  ...
  },
  {
    ...
    label: 'Concerned about voter fraud',
  },
  {
  ...
  },
  {
    ...
    label:
      'Believes the top 1% got rich through advantages they were handed (limited coverage: data exists in only 12 states; null elsewhere)',
  },
  {
    name: 'hs_wealth_acquired_hardwork',
    label:
      'Believes the top 1% got rich through hard work (limited coverage: data exists in only 12 states; null elsewhere)',
  },
]
