...
//   original survey question) and the briefing-chat topic catalog
//   (DISTRICT_TOPICS_CATALOG in llm/tools/districtTopics.tool.ts), not a
//   Title-Case of the column name. The seed's autogenerated higher-score-
//   direction lines are NOT trusted (they contradict the question text on
//   *_ban / *_oppose style columns); the column-name pole plus the question
//   text decide direction. Scores are within-state percentile ranks
