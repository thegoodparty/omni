...
// shared ChatStoreService (greeting seeding) and Organizations/Elections/
// Features for the reused constituent-data tool (district resolution + flag).
@Module({
  imports: [ChatsModule, OrganizationsModule, ElectionsModule, FeaturesModule],
  providers: [
    CampaignManagerHandler,
