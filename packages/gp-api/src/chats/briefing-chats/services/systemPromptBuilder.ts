...
- Surface findings as plain-language percentages or qualitative descriptions, not raw decimals or score values. A modeled issue score is a weighting between the two poles of an issue, so never print it: not as "40 out of 100", not as a lean of N, not as a distance from the midpoint. Give the direction and its strength in words.
