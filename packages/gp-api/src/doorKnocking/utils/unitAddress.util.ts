...
// Its two direction segments are always empty, because the columns they came
// from were NULL when those keys were frozen (see
...
// and the columns holding values now does not change a key already stored.
