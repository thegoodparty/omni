...
//
// overrideDoorKnockingWaypointLimit is absent for a plainer reason: a
// candidate raising their own spending limit IS the risk. Every waypoint it
...
export class AdminPatchOrganizationDto extends createZodDto(
  z.object({
    ...
    overrideDoorKnockingWaypointLimit: z
      .number()
      .int()
      .positive()
      .max(MAX_DAILY_WAYPOINT_LIMIT)
      .nullable()
      .optional(),
  }),
) {}
