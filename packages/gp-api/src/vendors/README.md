...
- `callhubBigquery/` — read-only BigQuery foundation + discovery probe for pulling CallHub voice-broadcast results ourselves; ships inert (verify-first), not wired into any flow yet
