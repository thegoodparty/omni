...
export const politicalPartyValues = [
  'Alliance',
...
export const genderValues = ['M', 'F', null]

export const homeownerValues = [
  'Home Owner',
  'Probable Home Owner',
  'Renter',
  null,
...
export const businessOwnerValues = [
  'Accountant',
  'Builder',
  'Contractor',
...
export const veteranValues = ['Yes', null]
...
export const presenceOfChildrenValues = ['Y', 'N', null]

export const voterStatusValues = [
  'Super',
  'Likely',
  'Unreliable',
  'Unlikely',
...
export const ethnictGroupsValues = [
...
export const ethnicDescriptionValues = [
  'Afghan',
