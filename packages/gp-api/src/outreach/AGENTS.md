...
taken). The STAGING and SEND sweeps accept BOTH `authorized` and `paid` (a `paid`
...
Nothing in the hold path is deleted; flip the flag OFF to restore it exactly. The
