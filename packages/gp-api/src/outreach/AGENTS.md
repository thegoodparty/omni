...
- **Window.** If the send (`Outreach.date`) is more than
  ...
  already-`authorized` row. This stores WHICH card to later charge — no hold, no
  money moved. The daily deferred sweep
