...
(the catalog is the assistant's vocabulary and carries no flag).
...
| Assistant refuses / weird tool behavior                        | For Serve, check `serve-crm` for the user (server-evaluated); for Win, tools register whenever `contacts` + the organization resolve — no flag. Locked-filter 409 surfaces as an explanation. Note gp-api-dev evaluates flags against the PROD Amplitude project                                                                                                                                                                                                                                                                                                      |
