...
| `POST /v1/contacts/count`                                                          | Live count for an unsaved filter (wizard running total; assistant `count_contacts` parity). Open to a free Win campaign (outreach-pro-gating-v2): the outreach build path prices a list before the upgrade, and a count is a number about the district, not a voter record                                                                                                                                                                                                                                                                                                                                                                 |
