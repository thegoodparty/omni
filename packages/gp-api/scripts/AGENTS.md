...
| `stripe-campaign-reconcile.ts`                                    | Walks Stripe's Pro subscriptions against `campaign.details.subscriptionId`; read-only drift report (refund candidates, duplicates, stale Pro) |
