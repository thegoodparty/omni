"""Mirrors engineer_agent/tests/test_github_auth.py against autopilot's copy
of the module (see autopilot/agent/github_auth.py's docstring for why it is a
copy, not an import). Named distinctly per the gp-ai suite's basename-clash
rule.
"""
...
from autopilot.agent.github_auth import (
    GITHUB_APP_ID,
