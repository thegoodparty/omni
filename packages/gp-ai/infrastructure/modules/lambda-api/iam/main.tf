...
# NOTE: IAM user and access keys removed - Lambda functions use execution roles
# If programmatic access is needed, use AWS SSO or temporary credentials via STS
