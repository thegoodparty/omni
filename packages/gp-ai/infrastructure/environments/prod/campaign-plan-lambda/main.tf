terraform {
  ...
  backend "s3" {
    ...
    key    = "campaign-plan-lambda/prod/terraform.tfstate"
    region = "us-west-2"
...
module "campaign_plan_lambda" {
  ...
  environment                     = "prod"
  output_sqs_queue_arn            = "arn:aws:sqs:us-west-2:333022194791:master-Queue.fifo"
  output_sqs_queue_url            = "https://sqs.us-west-2.amazonaws.com/333022194791/master-Queue.fifo"
