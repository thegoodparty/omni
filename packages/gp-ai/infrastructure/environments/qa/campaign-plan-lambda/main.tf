terraform {
  ...
  backend "s3" {
    ...
    key    = "campaign-plan-lambda/qa/terraform.tfstate"
    region = "us-west-2"
...
module "campaign_plan_lambda" {
  ...
  environment                     = "qa"
  output_sqs_queue_arn            = "arn:aws:sqs:us-west-2:333022194791:qa-Queue.fifo"
  output_sqs_queue_url            = "https://sqs.us-west-2.amazonaws.com/333022194791/qa-Queue.fifo"
