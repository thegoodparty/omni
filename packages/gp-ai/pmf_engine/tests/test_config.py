...
@pytest.mark.parametrize("env", ["local", "development", "dev", "prod"])
...
@pytest.mark.parametrize("env", ["PROD", "Dev", "DEV", "prod ", " dev", "Prod"])
