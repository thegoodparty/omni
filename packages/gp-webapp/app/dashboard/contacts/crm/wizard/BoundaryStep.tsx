...
import { useListPeople } from '../map/useListPeople'
...
interface BoundaryStepProps {
  ...
  // the dots below are the district, and only the server knows which of them
  // the filters kept.
...
export default function BoundaryStep({
  ...
  const { people, truncated, isLoading } = useListPeople(
    enabled ? ALL_SEGMENTS : null,
  )
