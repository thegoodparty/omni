...
import BriefingDispatchBanner from '../components/BriefingDispatchBanner'
import { useBriefingDispatch } from './use-briefing-dispatch'

// Mirrors how DashboardContent composes the two: the hook owns the dispatch
// and poll, the banner only renders what it reports.
const Harness = (): React.JSX.Element => {
  const { inFlight } = useBriefingDispatch()
  return <BriefingDispatchBanner inFlight={inFlight} />
}
