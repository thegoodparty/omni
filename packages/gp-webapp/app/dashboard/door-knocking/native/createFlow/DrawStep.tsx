...
export const DrawStep = ({
  ...
  <div className="flex flex-col gap-6">
    ...
    >
      ...
      >
        {/* Visual mimic of the styleguide Button primary variant — same
            classes as button.tsx's `default` variant, plus a shadow so it
            stands out over the map. Not a real <Button> because nesting a
            button inside the wrapping <button> is invalid HTML; the card
