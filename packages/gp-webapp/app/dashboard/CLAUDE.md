...
| `shared/DashboardLayout.tsx` | Layout wrapper — sidebar, header, auth gating. Pass `navHeader={{ icon, label, hasAction? }}` to render a full-bleed in-body header that mirrors the active nav item (every main nav page uses it) |
