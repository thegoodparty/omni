      ...
      {hasAppliedPromo ? (
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="min-w-0 flex-1 rounded-lg border border-gray-300 px-4 py-3 text-base outline-none focus:border-primary-main focus:ring-1 focus:ring-primary-main"
          />
          <Button
            type="button"
