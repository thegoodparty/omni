...
CREATE TABLE "Race" (
    ...
    "filing_office_address" TEXT NOT NULL,
    "filing_phone_number" TEXT NOT NULL,
    "paperwork_instructions" TEXT NOT NULL,
    "filing_requirements" TEXT NOT NULL,
    "is_runoff" BOOLEAN NOT NULL,
    "is_primary" BOOLEAN NOT NULL,
    "partisan_type" TEXT NOT NULL,
    "location_name" TEXT NOT NULL,
    "filing_date_start" TEXT NOT NULL,
    "filing_date_end" TEXT NOT NULL,
    "employment_type" TEXT NOT NULL,
    "eligibility_requirements" TEXT NOT NULL,
    "salary" TEXT NOT NULL,
    "municipality_popluation" INTEGER NOT NULL,
    "municipality_density" DOUBLE PRECISION NOT NULL,
    "municipality_income_household_median" INTEGER NOT NULL,
    "municipality_unemployment_rate" DOUBLE PRECISION NOT NULL,
    "municipality_home_value" INTEGER NOT NULL,
    "city_largest" TEXT NOT NULL,
    "county_population" INTEGER NOT NULL,
    "county_density" DOUBLE PRECISION NOT NULL,
    "county_income_household_median" INTEGER NOT NULL,
    "county_unemployment_rate" DOUBLE PRECISION NOT NULL,
    "county_home_value" INTEGER NOT NULL,
    "state" TEXT NOT NULL,
