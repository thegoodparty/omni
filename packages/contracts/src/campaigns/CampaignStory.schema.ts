...
/**
 * A candidate's campaign story: the free-text `background` answer shown on the
 * Campaign Story page. Persisted 1:1 with a campaign in gp-api's
 ...
 * candidate's `why` and issues are NOT part of the story — they live on the
 * website (`Website.content.about.bio` and `.issues`), shared with the
 * Pro-upgrade flow.
 */
