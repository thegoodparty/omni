...
hubspot-mapping-test@goodparty.org --properties email`) before sending; if
the search comes back empty, stop and have the human create it in the prod
UI. Never send a test occurrence to a candidate, user, or staff
